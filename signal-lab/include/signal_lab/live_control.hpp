...
public:
    ...
    {
        return stats_.frames;
    }
    [[nodiscard]] std::uint64_t seed() const noexcept
    {
        return seed_;
    }
    [[nodiscard]] double reference_rms() const noexcept
    {
        return reference_rms_;
    }
    [[nodiscard]] const LiveState& state() const noexcept
    {
        return state_;
    }
    [[nodiscard]] const LiveStats& stats() const noexcept
    {
        return stats_;
    }
    ...
    [[nodiscard]] std::size_t capture_count() const noexcept
    {
        return capture_count_;
    }
    [[nodiscard]] const ControlEvent* capture_data() const noexcept
    {
        return capture_;
    }
