...
const char* control_result_name(ControlResult result) noexcept
{
    switch (result)
    {
    case ControlResult::accepted: return "accepted";
    case ControlResult::not_configured: return "not_configured";
    case ControlResult::invalid_event: return "invalid_event";
    case ControlResult::late_event: return "late_event";
    case ControlResult::pending_full: return "pending_full";
    case ControlResult::capture_full: return "capture_full";
    }
...
const char* control_kind_name(ControlKind kind) noexcept
{
    switch (kind)
    {
    case ControlKind::cw_enable: return "cw_enable";
    case ControlKind::cw_frequency: return "cw_frequency";
    case ControlKind::cw_ci: return "cw_ci";
    case ControlKind::static_enable: return "static_enable";
    case ControlKind::static_rate: return "static_rate";
    case ControlKind::static_peak: return "static_peak";
    case ControlKind::fade_now: return "fade_now";
    }
    return "invalid";
}
