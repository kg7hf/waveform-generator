...
struct PlayerSnapshot
{
    ...
    // Impairment engine (2:/WG/PLAY.SCN): 0 = no scenario (clean pass-through),
...
/*
 * Start the engineering slice in an idle state. After the USB owner grants
 ...
 */
[[nodiscard]] m110::Status start_player() noexcept;
