...
This is separate from the frozen WFG/1 qualification/ARM protocol. Physical use
requires pyserial==3.5, an explicit port, and the expected fixture USB serial.
...
def replay(controller: Controller, plan: dict, *, sleep=time.sleep):
    ...
    for field in ("usb_serial", "source_manifest_sha256"):
