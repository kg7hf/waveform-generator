...
`WFG-LIVE/1` is an engineering protocol. It is deliberately separate from the
frozen `WFG/1` qualification/ARM contract.
...
| RT1170 response/state bridge | `rt1170/player.cpp`, `rt1170/usb_checkpoint.cpp` |
