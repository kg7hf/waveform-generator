...
void commands()
{
    ...
    for (const auto* token : {"75S", "75L", "150S", "150L", "300S", "300L", "600S",
    ...
    for (const auto* text : {"CMD:WAV FILE:../A.WAV\n", "CMD:WAV FILE:a.WAV\n",
...
struct Endpoint
{
    ...
    static m110::Status state(void*, m110::CdcMuxChannel, bool) noexcept { return m110::Status::success(); }
